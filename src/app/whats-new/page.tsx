...
export default function WhatsNewPage() {
  ...
  return (
    <div className="flex flex-col w-full">
          ...
          <FadeIn direction="up">
            <div className="max-w-4xl space-y-6">
              <span className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.25em] text-brand-bright bg-brand-bright/10 border border-brand-bright/30 px-4 py-1.5 rounded-full">
                <Sparkles className="w-3.5 h-3.5" /> Latest Launches & Industry News
              </span>
              ...
              <p className="text-white/80 text-base sm:text-xl leading-relaxed max-w-2xl">
                Stay updated with our latest seasonal knitted collection drops, textile exhibition highlights, plant technology modernization, and company milestones.
              </p>
            </div>
          </FadeIn>
        </div>
      ...
      <section className="py-8 bg-muted/50 border-b border-border sticky top-16 md:top-20 z-30 backdrop-blur-md">
            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-full whitespace-nowrap transition-all ${
                    isSelected
                ...
                <div className="bg-card border border-border rounded-3xl overflow-hidden shadow-md hover:shadow-2xl hover:border-primary/50 hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between h-full group">
                  ...
                  <div className="relative h-56 w-full overflow-hidden bg-muted">
                    ...
                    <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
                      <span className={`text-[10px] uppercase font-bold tracking-widest px-3 py-1 rounded-full border backdrop-blur-md bg-black/60 ${item.badgeColor}`}>
                        {item.badge}
                      </span>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8 backdrop-blur-md">
            <div className="space-y-2 max-w-xl">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-bright block">Direct Factory Connect</span>
